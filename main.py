...
LOCAL_PARSER.add_argument('-r', '--retrieve', action='store_true', help='retrieve a singnal')
LOCAL_PARSER.add_argument('-s', '--send', help='send a signal data or api response')
